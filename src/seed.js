...
const seedDatabase = async () => {
  try {
    ...
    const farmacias = [
      { nombre: 'Farmacia Central', direccion: 'Av. Principal 123', telefono: '123456789', email: 'central@farmacia.com' },
      { nombre: 'Farmacia del Pueblo', direccion: 'Calle Falsa 456', telefono: '987654321', email: 'pueblo@farmacia.com' },
      { nombre: 'Farmacia Express', direccion: 'Boulevard Los Olivos 789', telefono: '555555555', email: 'express@farmacia.com' }
    ];
